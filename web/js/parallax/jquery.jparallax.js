...
// A cheap hack!
	for (var i=0; i<layer.length; i++) {
		...
		if (layer[i].xparallax) layer[i].element.css("left", layer[i].xoffset - (0.1*viewport.width) * layer[i].xdynamic);
		if (layer[i].yparallax) layer[i].element.css("top", layer[i].yoffset - (0.1*viewport.height) * layer[i].ydynamic);
